        ...
        <section className="contentContainer flex justify-between items-center h-screen relative">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative z-10">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    ...
                    <a href="./src/components/About" className="py-3 px-5 sm:ms-4 text-sm font-medium text-gray-900 focus:outline-none bg-gray-800 rounded-lg border border-gray-200 hover:bg-gray-500 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-70">
                        Learn more
                    </a>  
                </div>
            </div>
